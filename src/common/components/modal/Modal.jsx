...
const Modal = ({ name, open, onClose, onConfirmationClose, children }) => {
  return (
    open && (
      <div className="h-screen w-screen top-0 left-0 right-0 bottom-0 fixed z-30">
        <div
          className="h-screen w-screen top-0 left-0 right-0 bottom-0 fixed  bg-[rgba(49,49,49,0.8)]"
          onClick={onClose}
        ></div>
        <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 leading-snug bg-[#fff] px-10 py-4 rounded-md max-w-[600px] min-w-[300px]">
